...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-HVkOs2/python2.7-2.7.13=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-HVkOs2/python2.7-2.7.13=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-HVkOs2/python2.7-2.7.13=.', '-fstack-protector-strong', '-fwrapv']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-HVkOs2/python2.7-2.7.13=.', '-fstack-protector-strong', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['realtime', 'naming', 'socket', 'tutorial', 'stats', 'energy', 'udp-client-server', 'tcp', 'traffic-control', 'ipv6', 'wireless', 'matrix-topology', 'routing', 'error-model', 'udp']
...
NS3_EXECUTABLE_PATH = ['/home/jonatas/unb/Projeto-Teleinformatica-e-Redes-1/ns-3.27/build/src/fd-net-device', '/home/jonatas/unb/Projeto-Teleinformatica-e-Redes-1/ns-3.27/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/6', '/home/jonatas/unb/Projeto-Teleinformatica-e-Redes-1/ns-3.27/build']
...
cfg_files = ['/home/jonatas/unb/Projeto-Teleinformatica-e-Redes-1/ns-3.27/build/ns3/config-store-config.h', '/home/jonatas/unb/Projeto-Teleinformatica-e-Redes-1/ns-3.27/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
